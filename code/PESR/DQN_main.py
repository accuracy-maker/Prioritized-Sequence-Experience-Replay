...
import random
from PrioritizedSequenceReplayBuffer import PrioritizedSequenceReplayBuffer
from DQN import DQN
...
def run_experiment(config, n_seeds=10):
    torch.manual_seed(0)
    mean_rewards = []
...
if __name__ == '__main__':
    ...
    ps_mean_priority_reward, ps_std_priority_reward = run_experiment(config, n_seeds=1)
